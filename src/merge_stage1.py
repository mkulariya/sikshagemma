...
DEFAULT_ADAPTER_DIR = "stage1_gemma4_e4b/final_adapter"
DEFAULT_OUTPUT_DIR = "merged_stage1"


def parse_args():
    parser = argparse.ArgumentParser(description="Merge Stage 1 LoRA adapter into base model (bf16)")
...
def main():
    ...
    print("Done. Merged model ready for Stage 2 training.")
